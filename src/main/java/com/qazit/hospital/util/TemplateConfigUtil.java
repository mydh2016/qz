...
public class TemplateConfigUtil {
	...
	private static File _cfFile = new File(TemplateConfigUtil.class.getResource("/template.properties").getPath());
	...
	public static void main(String args[]){
		System.out.println(TemplateConfigUtil.getProperty("security.service.url"));
	}
