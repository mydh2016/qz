...
<div class="hs_appoint">
    <div class="container">
        ...
        <section class="hs_appoint_hos row">
                <a href="${base_path }/rest/app/depart/alldepartment?hcode=${hospital.hcode}">
            ...
            <div class="hs_appoint_hos_text col-xs-7">
                <h3><a href="${base_path }/rest/app/depart/alldepartment?hcode=${hospital.hcode}">${hospital.hospitalName }</a></h3>
