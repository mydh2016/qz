             	...
             	$.ajax({
     				...
     				success:function(json){
    					...
    					for(var i=0;i<result.length;i++){
     					html +="<li><a href='/qazitem/rest/app/medpedia/getMedpediaInfo?id="+result[i].publish_content_id+"'><h4>"+result[i].publish_content_name +"</h4><p class='hs_health_main_time'>"+result[i].publishDate+"</p><i class='icon iconfont icon-icon'></i></a></li>";
    					}
    					child.append(html);
     				},
