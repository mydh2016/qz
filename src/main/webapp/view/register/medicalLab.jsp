...
<head lang="en">
    ...
    <script src="${base_path }/view/register/js/medicalLab.js"></script>
</head>
<body>
<div class="hs_medLab">
    <div class="container">
        <header class="topBar">
			  <a href="${base_path }/rest/app/hospital/appoint?status=0"><i class="icon iconfont icon-fanhuijian"></i></a>
